        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AnotherPet = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OwnedAnimalBefore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    HoursAnimalAlone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RequestedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PetMarriageRequests", x => x.RequestId);
                    table.ForeignKey(
                        name: "FK_PetMarriageRequests_Pets_ReceiverPetId",
                        column: x => x.ReceiverPetId,
                        principalTable: "Pets",
                        principalColumn: "PetId");
                    table.ForeignKey(
                        name: "FK_PetMarriageRequests_Pets_SenderPetId",
                        column: x => x.SenderPetId,
                        principalTable: "Pets",
                        principalColumn: "PetId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PetMarriageRequests_ReceiverPetId",
                table: "PetMarriageRequests",
                column: "ReceiverPetId");

            migrationBuilder.CreateIndex(
                name: "IX_PetMarriageRequests_SenderPetId",
                table: "PetMarriageRequests",
                column: "SenderPetId");
